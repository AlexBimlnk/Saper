...
public class DSU {
     ...
     * @throws IndexOutOfBoundsException Если индекс меньше нуля или выходи за границы родительского множества.
     * @throws InvalidParameterException Если множество с выбранным индексом не существует.
     */
     ...
     * @throws IndexOutOfBoundsException Если индекс меньше нуля или выходи за границы родительского множества.
     * @throws InvalidParameterException Если множество с выбранным не существует.
     */
